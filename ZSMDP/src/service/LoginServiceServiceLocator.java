...
public class LoginServiceServiceLocator extends org.apache.axis.client.Service implements service.LoginServiceService {
    ...
    private java.lang.String LoginService_address = "http://localhost:8080/CZSMDP/services/LoginService";
    ...
    public service.LoginService getLoginService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            service.LoginServiceSoapBindingStub _stub = new service.LoginServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (service.LoginService.class.isAssignableFrom(serviceEndpointInterface)) {
                service.LoginServiceSoapBindingStub _stub = new service.LoginServiceSoapBindingStub(new java.net.URL(LoginService_address), this);
                _stub.setPortName(getLoginServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service", "LoginServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service", "LoginService"));
        }
