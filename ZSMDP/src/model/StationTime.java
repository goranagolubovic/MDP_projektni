...
public class StationTime {
	...
	public String toString() {
		...
		return station+"  "+time+"  "+trainArrived;
	}
	public String jsonFormat() {
		String jsonFormat="";
		jsonFormat+="\"actualTimeOfPassing\":\""+this.actualTimeOfPassing+"\",\"isTrainArrived\":\""+this.isTrainArrived+"\",\"station\":\""+this.station+"\",\"time\":\""+this.time+"\"";
		return jsonFormat;
	}
}